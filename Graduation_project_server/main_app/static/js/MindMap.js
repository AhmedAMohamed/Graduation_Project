...
MindMap = function(){
    ...
    mindmap = function(data) {
  	...
  	update = function(){
		...
		nodeEnter.append("svg:circle")
   		...
   		nodeEnter.append("svg:image")
			      .attr("xlink:href", function(d){
			      	return d.root1? "/static/center_node_out.png":"";
			      })
			      .attr("width", "150px")
			      .attr("height", "150px")
			      .attr("align","center")
		...
		nodeEnter.append("svg:image")
			      .attr("xlink:href", function(d){
			      	return d.root1? "/static/center_node_group.png":"";
			      })
			      .attr("width", "100px")
			      .attr("height", "100px")
			      .attr("align","center")
		...
		var icon = nodeEnter.append("svg:image")
			      .attr("xlink:href", function(d){ 
			      	if (d.get_image && !d.image) {
		      		$.ajax({
					    url: '/icon?term=' + d.name.trim().split(' ').pop(),
					    type: 'GET',
					    dataType: 'json',
					    success: function(data) {
					    	console.log(JSON.stringify(data, null, 4));
					    	d.image = data.icon.preview_url_42;
			      		},
					    error: function(data) { 
					    	console.log('error');
					    },
